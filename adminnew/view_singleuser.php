<?php include("includes/header.php");
  ...
  if(isset($_REQUEST['group_id']))
 {
     ...
     $fbid=$_REQUEST['fb_id'];
     $usql="SELECT * FROM user where fb_id='$fbid'";
     $userresult=mysqli_query($mysqli,$usql); 
     $user_result=mysqli_fetch_assoc($userresult);
    $user_name=$user_result['first_name'].'  '.$user_result['last_name'] . '('.$fbid.')';
    //print_r($user_result);
 }
 ...
 <!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        User Record <?php echo $user_name; ?> in group <?php echo $custom_group_name; ?>
      </h1>
      <ol class="breadcrumb">
...
<script type="text/javascript" language="javascript" >
 ...
 //Your  code
    var tt=user_data('' , '' ,<?php echo $_REQUEST['group_id'];?> ,<?php echo $_REQUEST['fb_id'];?>  , 'user');
