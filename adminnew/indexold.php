...
<body class="hold-transition login-page">
  ...
  <div class="login-logo">
    <a href="index.php"><b>Fworld Group</b></a>
  </div>
  <?php  if(isset($msg)) {
  echo  $msg;} ?>
  ...
  <div class="login-box-body">
    ...
    <form action="" method="post">
      <div class="form-group has-feedback">
        <input type="text" name="txtemail" class="form-control" placeholder="Username" id="username" autofocus>
        <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
        <input type="password" name="txtupass" class="form-control" id="pass" placeholder="Password">
