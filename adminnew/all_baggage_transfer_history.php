...
<div class="content-wrapper"> 
  ...
  <section class="content-header">
    <h1>ALL Baggage Transfer</h1>
    <ol class="breadcrumb">
      <li><a href="vwDashboard.php"><i class="fa fa-dashboard"></i> Home</a></li>
      <li class="active">ALL Baggage Transfer list</li>
    </ol>
  </section>
 ...
 <div class="box box-default collapsed-box ">
    ...
    <div class="box-header with-border">
      <h3 class="box-title">ALL Baggage Transfer</h3>
      <div class="box-tools pull-right">
        <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
      </div>
    </div>
    ...
    <div class="box-body table-responsive">
      	...
      	<div class="col-xs-12">
       <button type="button" class="btn btn-primary pull-right" data-toggle="modal" data-target="#exampleModalCenter_send_gift">
        Send Gift
       </button>
  ...
  $(document).ready( function () {
       ...
       // "scrollX": true,
        ...
        "buttons": [
             'excel'
                ...
                "ajax":{
                    url :"ajax/get_all_baggage_transfer_history.php",
                    type: "post",
                    data: function ( data ) {
    ...
    $('#btn-reset').click(function(){ //button reset event click
     ...
     $('#user_table').on( 'click', 'a.remove_I_id', function () {
        ...
        console.log(id);
         if (confirm('Are you sure you want to delete this Baggage Transfer Details?')) {
         $.ajax({
              type: "POST",
              data: {del_user_id:id},
              url :"ajax/del_baggage.php",
