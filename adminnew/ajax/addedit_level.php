            ...
            <form role="form" method="post" enctype="multipart/form-data">
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="" placeholder="Enter Date" required  value="<?php if(isset($row)){ echo $row['date'];}else{ echo date('Y-m-d'); } ?>"  readonly>
                </div>
				...
				<?php if(isset($row)){ ?>
                  <img src="<?php if(isset($row)){echo $row['icon'];}?>">
                <?php } ?>
