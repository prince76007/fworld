...
if($_POST["submit"]=="Update"){
    ...
    if(isset($_FILES['gift_icon']['name']) && $_FILES['gift_icon']['name']!=""){
        ...
        $badge_color_icon=uniqid().$_FILES['gift_icon']['name'];
   ...
   $extmsg="";
    ...
    $gift_icon_image="";
     if(isset($_FILES['gift_icon']['name']) && $_FILES['gift_icon']['name']!=""){
      ...
      $sql1="INSERT INTO `gift`( `gift_title`, `gift_icon`, `gift_qty`, `gift_amt`, `gift_des`, `gift_date`, `gift_exp`, `gift_diamond`, `gift_status`) VALUES (
        '".$gift_title."' , 
