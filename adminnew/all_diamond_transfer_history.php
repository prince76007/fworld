...
<div class="content-wrapper"> 
  ...
  <section class="content-header">
    <h1>ALL Diamond Transfer</h1>
    <ol class="breadcrumb">
      <li><a href="vwDashboard.php"><i class="fa fa-dashboard"></i> Home</a></li>
      <li class="active">ALL Diamond Transfer list</li>
    </ol>
  </section>
...
<select id="4" class="employee-search-input form-control" required> <option value="" >Status</option>
    ...
    <div class="box-header with-border">
      <h3 class="box-title">ALL Diamond Transfer</h3>
      <div class="box-tools pull-right">
        <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
        <button type="button" class="btn btn-box-tool" data-widget="remove"><i class="fa fa-remove"></i></button>
      </div>
  ...
  $(document).ready( function () {
    var table =$('#user_table').DataTable({
       ...
       // "scrollX": true,
        ...
        "buttons": [
             'excel'
                ...
                "ajax":{
                    url :"ajax/get_all_diamond_transfer_history.php",
                    type: "post",
     ...
     $('#user_table').on( 'click', 'a.remove_I_id', function () {
        ...
        console.log(id);
         if (confirm('Are you sure you want to delete this Diamond Transfer Details?')) {
         $.ajax({
              type: "POST",
              data: {del_user_id:id},
              url :"ajax/del_diamond.php",
