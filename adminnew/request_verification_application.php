...
<div class="content-wrapper"> 
  ...
  <section class="content-header">
    <h1>ALL Verification Application</h1>
    <ol class="breadcrumb">
      <li><a href="vwDashboard.php"><i class="fa fa-dashboard"></i> Home</a></li>
      <li class="active">ALL Verification Application list</li>
    </ol>
  </section>
 ...
 <div class="box box-default collapsed-box ">
    ...
    <div class="box-header with-border">
      <h3 class="box-title">ALL Verification Application</h3>
      <div class="box-tools pull-right">
        <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
        <button type="button" class="btn btn-box-tool" data-widget="remove"><i class="fa fa-remove"></i></button>
      </div>
...
<script type="text/javascript" language="javascript" >
  $(document).ready( function () {
    var table =$('#user_table').DataTable({
        ...
        "buttons": [
             'excel'
                ...
                "ajax":{
                    url :"ajax/get_request_verification_application_list.php",
                    type: "post",
                    data: function ( data ) {
    ...
    $('#btn-reset').click(function(){ //button reset event click
     ...
     $('#user_table').on( 'click', 'a.remove_id', function () {
        ...
        console.log(id);
         ...
         $.ajax({
              type: "POST",
              data: {del_user_id:id},
              url : "ajax/del_request_verification_application.php",
